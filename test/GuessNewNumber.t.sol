...
contract GuessNewNumberTest is Test {
    GuessTheNewNumberChallenge vulnContract;
    GuessNewNumberAttack       attackContract;
 
    function setUp() public {
        vulnContract   = new GuessTheNewNumberChallenge{value: 1 ether}();
        attackContract = new GuessNewNumberAttack{value: 1 ether}();
    }
